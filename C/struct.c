...
void main()
{
    ...
    for (i = 0; i < 6; i++)
    {
        read_line(This_Employee.address[i]);
    }

    print_employee(This_Employee);

    printf("Address: %p\n", (void*) &This_Employee);
    printf("Address: %p\n", (void*) &This_Employee.age);
    printf("Address: %p\n", (void*) &This_Employee.salary);
    printf("Address: %p\n", (void*) &This_Employee.department);
    printf("Address: %p\n", (void*) &This_Employee.name);
    printf("Address: %p\n", (void*) &This_Employee.address);

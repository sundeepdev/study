/*
    You have a binary search tree and you have to return the two nodes
    such that their sum i equals to 'K'. Pseudo code is to be given.

    O(n) time & O(n) space is easy but challenge O(n) time & (1) space.
*/
